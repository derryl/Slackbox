...
//
// Simple, jQuery-like library for DOM interaction.
// This is a modified version of Andrey Gubanov's "balalaika.js".
// >> https://github.com/finom/balalaika <<
//

define( [], function() {

    var $ = ( function( window, document, fn, nsRegAndEvents, id, s_EventListener, s_MatchesSelector, i, j, k, l, $ ) {
        ...
        $.i[ l = 'prototype' ] = ( $.extend = function(obj) {
            ...
            addClass: function( c ) {
                ...
                this.map( function( item ) {
                    ...
                    c.forEach( function( klass ) {
                        if (k.indexOf(klass) < 0) k.push(klass)
                    });
                    
                    item.setAttribute('class', k.join(' '));
                });
            ...
            removeClass: function( c ) {
                ...
                this.map( function( item ) {
                    ...
                    k = k.map( function( klass ) {
                        return ( c.indexOf( klass ) > -1 ) ? '' : klass;
                    });
                    
                    item.setAttribute('class', k.join(' ').trim());
                });
